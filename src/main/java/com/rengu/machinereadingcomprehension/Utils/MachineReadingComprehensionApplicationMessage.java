...
public class MachineReadingComprehensionApplicationMessage {

    // 用户相关提示信息
    public static final String USER_NOT_FOUND = "未发现该用户";
    public static final String USER_ROLE_PARAM_NOT_FOUND = "用户角色参数未发现";
    public static final String USER_PARAM_NOT_FOUND = "用户参数不存在";
    public static final String USER_USERNAME_PARAM_NOT_FOUND = "用户名参数不存在";
    ...
    public static final String USER_INFORMATION_ERROR = "用户信息（姓名、电话、邮件地址）不吻合";

    // 角色相关提示信息
    public static final String ROLE_PARAM_NOT_FOUND = "角色参数不存在";
    public static final String ROLE_NAME_PARAM_NOT_FOUND = "角色名称参数不存在";
    public static final String ROLE_NAME_EXISTS = "角色中已存在该角色名称";
